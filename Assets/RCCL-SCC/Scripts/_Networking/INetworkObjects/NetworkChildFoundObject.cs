...
//</example>
public class NetworkChildFoundObject : INetworkObject
{
    public CancellationTokenSource cts { get; set; }

    public NetworkChildFoundObject()
    {
    ...
    public NetworkChildFoundObject(NetworkEvent newNetEvent, string newPlayerID, object newNetData)
    {
    ...
    public bool ConvertFromNetworkObject(object[] value)
    {
        try
        {
            ...
            if((string) values[3] != "KidTracking")
                return false;
            return true;
        }
